...
#define HAL_FLASH_BASE_ADDR      (uint32_t)(FLASH_BASE)		 		    //FLASH起始地址---请按实际定义
#define HAL_FLASH_END_ADDR       (uint32_t)(FLASH_BANK1_END) 			//FLASH结束地址---请按实际定义
...
#define HAL_FLASH_SIZE      (HAL_FLASH_END_ADDR - HAL_FLASH_BASE_ADDR)	//FLASH总大小
